...
<div class="px-4 md:px-6 lg:px-10 xl:px-20 py-5">
    <div class="max-w-4xl w-full mx-auto">
        ...
        <div class="bg-white dark:bg-background-dark border border-border-light dark:border-border-dark rounded-lg shadow-sm p-6 sm:p-8">
            ...
            <form class="flex flex-col gap-8" action="<?php echo e(route('reports.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="flex flex-col gap-6">
                        <label class="flex flex-col">
                            ...
                            <select name="kecamatan"
                                ...
                                <option value="Sidikalang" <?php echo e(old('kecamatan') == 'Sidikalang' ? 'selected' : ''); ?>>Sidikalang</option>
                                <option value="Sumbul" <?php echo e(old('kecamatan') == 'Sumbul' ? 'selected' : ''); ?>>Sumbul</option>
                                <option value="Tigalingga" <?php echo e(old('kecamatan') == 'Tigalingga' ? 'selected' : ''); ?>>Tigalingga</option>
                                <option value="Berampu" <?php echo e(old('kecamatan') == 'Berampu' ? 'selected' : ''); ?>>Berampu</option>
                            </select>
                        </label>
                        ...
                        <label class="flex flex-col">
                            ...
                            <textarea name="deskripsi" rows="5"
                                ...
                                placeholder="Jelaskan pelanggaran yang Anda lihat secara rinci..."><?php echo e(old('deskripsi')); ?></textarea>
                        </label>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <label class="flex flex-col">
                            ...
                            <input type="tel" name="phone" value="<?php echo e(old('phone')); ?>" placeholder="Contoh: 081234567890"
                        ...
                        <label class="flex flex-col">
                            ...
                            <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Contoh: nama@email.com"
                                class="form-input w-full rounded-lg border border-border-light dark:border-border-dark bg-white dark:bg-background-dark p-4 text-base text-text-light dark:text-text-dark placeholder:text-subtle-light dark:placeholder:text-subtle-dark focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/50 h-14">
                        </label>
                    </div>
                </div>
