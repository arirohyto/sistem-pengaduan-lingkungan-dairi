    ...
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <aside
            ...
            <div class="flex justify-center md:mb-6">
                <img src="<?php echo e(asset('images/logopemerintahkabdairi.png')); ?>" alt="Logo Pemkab Dairi"
            ...
            <nav class="flex flex-row flex-wrap md:flex-col gap-2 md:mt-4 w-full justify-center md:justify-start">
                <a class="flex items-center gap-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-primary/20 text-primary' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
                ...
                <a class="flex items-center gap-3 px-3 py-2 rounded-lg <?php echo e(request()->routeIs('admin.users.*') ? 'bg-primary/20 text-primary' : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800'); ?>" href="<?php echo e(route('admin.users.index')); ?>">
...
</html><?php /**PATH D:\laragon\www\sistem-pengaduan-lingkungan\resources\views/layouts/admin.blade.php ENDPATH**/ ?>