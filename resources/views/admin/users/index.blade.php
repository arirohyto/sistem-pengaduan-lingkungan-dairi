...
@section('title', 'Manajemen User - Sistem Pengaduan')
...
@section('content')
    <div class="p-4 sm:p-6">
        ...
        {{-- Filter --}}
        <form method="GET" action="{{ route('admin.users.index') }}" class="mb-4 flex flex-wrap gap-3 items-end">
            <div>
                ...
                <table class="min-w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse ($users as $user)
                            <tr>
                                <td class="px-3 py-2 text-xs sm:text-sm">{{ $user->name }}</td>
                                <td class="px-3 py-2 text-xs sm:text-sm">{{ $user->email }}</td>
                                <td class="px-3 py-2 text-xs sm:text-sm">{{ $user->phone ?? '-' }}</td>
