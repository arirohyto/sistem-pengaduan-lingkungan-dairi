<header
    ...
    <div class="flex items-center gap-3"> <a href="{{ route('home') }}" class="flex items-center gap-2"> <img
                src="{{ asset('images/logo-dlh.png') }}" alt="Logo Dairi" class="h-10 w-auto md:h-12 object-contain"
    ...
    {{-- Tombol menu mobile (opsional, nanti bisa kita aktifkan) --}}
    <button
