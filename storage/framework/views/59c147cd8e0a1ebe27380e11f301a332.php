...
<?php $__env->startSection('content'); ?>
        ...
        <div class="w-full max-w-7xl mx-auto">
                                ...
                                <?php $__currentLoopData = $lokasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                                        ...
                                        <td class="h-[72px] px-4 py-2 text-gray-600 dark:text-gray-400 text-sm">
                                            <?php echo e($lokasi->description ?? 'Kecamatan ' . $lokasi->name . ', Kabupaten Dairi'); ?>

                                        </td>
                                        <td class="h-[72px] px-4 py-2">
                                            <span
                                                class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium
                                                <?php echo e($lokasi->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                                <?php echo e($lokasi->is_active ? 'Aktif' : 'Nonaktif'); ?>
                                        ...
                                        <td class="h-[72px] px-4 py-2">
                                            <div class="flex items-center gap-2">
                                                <button type="button"
                                                    ...
                                                    data-id="<?php echo e($lokasi->id); ?>" data-name="<?php echo e($lokasi->name); ?>"
                                                    data-description="<?php echo e($lokasi->description); ?>"
                                                    data-active="<?php echo e($lokasi->is_active ? 'true' : 'false'); ?>"
                                                    title="Edit Lokasi">
                                                    <span class="material-symbols-outlined text-base">edit</span>
                                                </button>

                                                <form id="deleteForm-<?php echo e($lokasi->id); ?>" method="POST"
                                                    action="<?php echo e(route('admin.lokasi.destroy', $lokasi->id)); ?>"
                                                    style="display: inline;">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
                                                    <button type="button"
                                                        onclick="showDeleteModal(<?php echo e($lokasi->id); ?>, '<?php echo e(addslashes($lokasi->name)); ?>')"
            ...
            <div id="lokasiModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
                <div class="bg-white dark:bg-zinc-800 rounded-lg p-6 w-full max-w-md mx-4 shadow-xl">
                    ...
                    <form id="lokasiForm" method="POST" action="<?php echo e(route('admin.lokasi.store')); ?>">
                        <?php echo csrf_field(); ?>
    ...
    <script>
        ...
        function resetForm() {
            ...
            document.getElementById('lokasiForm').action = '<?php echo e(route('admin.lokasi.store')); ?>';
        ...
        function editLokasi(id, name, description, isActive) {
            ...
            document.getElementById('lokasiForm').action = '<?php echo e(route('admin.lokasi.update', ':id')); ?>'.replace(':id', id);
